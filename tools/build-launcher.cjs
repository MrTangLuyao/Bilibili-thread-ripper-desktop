...
const result = spawnSync(compiler, ["/nologo", "/target:exe", "/optimize+", "/reference:System.Web.Extensions.dll", "/reference:System.Windows.Forms.dll", `/out:${path.join(root, "BTR_Desktop.exe")}`, path.join(root, "launcher", "Program.cs")], { encoding: "utf8", windowsHide: true });

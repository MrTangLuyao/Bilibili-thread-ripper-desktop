...
const files=["BTR_Desktop.exe","desktop.json","install.ps1","README.md","LICENSE","docs/update-interface.md","docs/verification.md","dist/desktop.js","dist/payload.json","src/bootstrap.cjs","src/update-main.cjs","tools/asar.cjs","tools/client-package.cjs","tools/update-provider.cjs","tools/https-json.cjs"];
...
try {
  ...
  const manifest={schema:1,version:config.version,downloadUrl:RAW+"packages/"+name,sha256:sha(bytes),supportedClientVersions:config.supportedClientVersions};
